const token = require('../index.js').g_token;
...
module.exports = {
	...
	const response = await axios.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&type=channel&maxResults=1&q=${args[0]}&access_token=${token}`)
	...
	const response2 = await axios.get(`https://www.googleapis.com/youtube/v3/channels?id=${ch_id}&part=statistics&fields=items/statistics/subscriberCount&access_token=${token}`)
