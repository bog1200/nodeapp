...
module.exports = {
	...
	execute(message, args) { 
        ...
        .then(() =>{
          ...
          { name: 'Today', value: today.incidence[county] ,inline: true},,{name: 'Yesterday', value: historicalData[days(today,1)].incidence[county],inline: true},{ name: '7 days ago', value: historicalData[days(today,7)].incidence[county] ,inline: true},
